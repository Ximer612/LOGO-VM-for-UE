...
#include "UselessPlugin.h"
#include "HAL/ThreadManager.h"

DEFINE_LOG_CATEGORY(LogAIV); // in .cpp file

#define LOCTEXT_NAMESPACE "FUselessPluginModule"
...
void FUselessPluginModule::StartupModule()
{
...
void FUselessPluginModule::ShutdownModule()
{
...
bool FUselessPluginModule::Exec(UWorld* InWorld, const TCHAR* Cmd, FOutputDevice& Ar)
{
...
IMPLEMENT_MODULE(FUselessPluginModule, UselessPlugin)